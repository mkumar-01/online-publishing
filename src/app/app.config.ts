...
import { CreatePostEffects } from './store/effects/createpost.effect';
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    provideEffects([CounterEffects, PostsEffects, AuthorsEffects, ArticleDetailEffects, CreatePostEffects]),
